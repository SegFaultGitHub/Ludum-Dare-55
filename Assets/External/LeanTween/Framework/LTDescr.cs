 ...
 *                         &nbsp;&nbsp;<i>Example:</i>
 *                         <br>
 *                             &nbsp;&nbsp;LeanTween.moveX( gameObject, 1f, 1f).setEase( <a href="LeanTweenType.html">LeanTweenType</a>.easeInQuad ).setDelay(1f);
 *                             <br>
 *                                 <br>
 *                                     You can pass the optional parameters in any order, and chain on as many as you wish.
 *                                     <br>
 *                                         You can also <strong>pass parameters at a later time</strong> by saving a reference to what is returned.
 *                                         <br>
 *                                             <br>
 *                                                 Retrieve a <strong>unique id</strong> for the tween by using the "id" property. You can pass this to
 *                                                 LeanTween.pause, LeanTween.resume, LeanTween.cancel, LeanTween.isTweening methods
 *                                                 <br>
 *                                                     <br>
 *                                                         &nbsp;&nbsp;<h4>Example:</h4>
 ...
 *                                                                         &nbsp;&nbsp;// check if it is tweening before kicking of a new
 *                                                                         tween
 *                                                                     </div>
 ...
 */
    public class LTDescr {
        ...
        public int uniqueId {
            get {
                uint toId = this._id | this.counter << 16;
        ...
        public override string ToString() {
            return
                $"{(this.trans != null ? $"name:{this.trans.gameObject.name}" : "gameObject:null")} toggle:{this.toggle} passed:{this.passed} time:{this.time} delay:{this.delay} direction:{this.direction} from:{this.from} to:{this.to} diff:{this.diff} type:{this.type} ease:{this.easeType} useEstimatedTime:{this.useEstimatedTime} id:{this.id} hasInitiliazed:{this.hasInitiliazed}";
        }
        ...
        public void reset() {
            ...
            this.hasUpdateCallback = this.useEstimatedTime = this.useFrames = this.hasInitiliazed = this.onCompleteOnRepeat =
                this.destroyOnComplete = this.onCompleteOnStart = this.useManualTime = this.hasExtraOnCompletes = false;
            ...
            this.easeInternal = () => {
                ...
                if (this._optional.path.orientToPath) {
                    if (this._optional.path.orientToPath2d) {
                        this._optional.path.place2d(this.trans, val);
                    } else {
                        this._optional.path.place(this.trans, val);
                    }
                } else {
                    this.trans.position = this._optional.path.point(val);
                }
            };
            return this;
        }
        ...
        public LTDescr setMoveCurvedLocal() {
            ...
            this.easeInternal = () => {
                ...
                if (this._optional.path.orientToPath) {
                    if (this._optional.path.orientToPath2d) {
                        this._optional.path.placeLocal2d(this.trans, val);
                    } else {
                        this._optional.path.placeLocal(this.trans, val);
                    }
                } else {
                    this.trans.localPosition = this._optional.path.point(val);
                }
            };
            return this;
        }
            ...
            this.easeInternal = () => {
                ...
                if (this._optional.spline.orientToPath) {
                    if (this._optional.spline.orientToPath2d) {
                        this._optional.spline.place2d(this.trans, val);
                    } else {
                        this._optional.spline.place(this.trans, val);
                    }
                } else {
                    this.trans.position = this._optional.spline.point(val);
                }
            };
            return this;
        }
        ...
        public LTDescr setMoveSplineLocal() {
            ...
            this.easeInternal = () => {
                ...
                if (this._optional.spline.orientToPath) {
                    if (this._optional.spline.orientToPath2d) {
                        this._optional.spline.placeLocal2d(this.trans, val);
                    } else {
                        this._optional.spline.placeLocal(this.trans, val);
                    }
                } else {
                    this.trans.localPosition = this._optional.spline.point(val);
                }
            };
            return this;
        }
        ...
        public LTDescr setRotateAround() {
            ...
            this.easeInternal = () => {
                newVect = this.easeMethod();
                val = newVect.x;
                Vector3 origPos = this.trans.localPosition;
                Vector3 rotateAroundPt = this.trans.TransformPoint(this._optional.point);
                // Debug.Log("this._optional.point:"+this._optional.point);
                this.trans.RotateAround(rotateAroundPt, this._optional.axis, -this._optional.lastVal);
                Vector3 diff = origPos - this.trans.localPosition;

                this.trans.localPosition =
                    origPos
                    - diff; // Subtract the amount the object has been shifted over by the rotate, to get it back to it's orginal position
                this.trans.rotation = this._optional.origRotation;

                rotateAroundPt = this.trans.TransformPoint(this._optional.point);
                this.trans.RotateAround(rotateAroundPt, this._optional.axis, val);
        ...
        public LTDescr setRotateAroundLocal() {
            ...
            this.easeInternal = () => {
                ...
                val = newVect.x;
                Vector3 origPos = this.trans.localPosition;
                this.trans.RotateAround(
                    this.trans.TransformPoint(this._optional.point),
                    this.trans.TransformDirection(this._optional.axis),
                    -this._optional.lastVal
                );
                Vector3 diff = origPos - this.trans.localPosition;
                ...
                Vector3 rotateAroundPt = this.trans.TransformPoint(this._optional.point);
                this.trans.RotateAround(rotateAroundPt, this.trans.TransformDirection(this._optional.axis), val);
 ...
 = child.gameObject.renderer.material.color; this.fromInternal.x = col.a; break; }}}
			...
			break;
			#else
                SpriteRenderer ren = this.trans.GetComponent<SpriteRenderer>();
                if (ren != null) {
                    ...
                    } else if (this.trans.GetComponent<Renderer>() != null
                               && this.trans.GetComponent<Renderer>().material.HasProperty("_TintColor")) {
                        Color col = this.trans.GetComponent<Renderer>().material.GetColor("_TintColor");
                        this.fromInternal.x = col.a;
                    } else if (this.trans.childCount > 0) {
                        foreach (Transform child in this.trans) {
        ...
        public LTDescr setTextAlpha() {
            ...
            this.easeInternal = () => { textAlphaRecursive(this.trans, this.easeMethod().x, this.useRecursion); };
            return this;
        }

        public LTDescr setAlphaVertex() {
            this.type = TweenAction.ALPHA_VERTEX;
            this.initInternal = () => { this.fromInternal.x = this.trans.GetComponent<MeshFilter>().mesh.colors32[0].a; };
            this.easeInternal = () => {
                newVect = this.easeMethod();
                val = newVect.x;
        ...
        public LTDescr setColor() {
			...
			#else
                SpriteRenderer renColor = this.trans.GetComponent<SpriteRenderer>();
                if (renColor != null) {
                    this.setFromColor(renColor.color);
                } else {
                    if (this.trans.GetComponent<Renderer>() != null && this.trans.GetComponent<Renderer>().material.HasProperty("_Color")) {
                        Color col = this.trans.GetComponent<Renderer>().material.color;
            ...
            this.easeInternal = () => {
                ...
                if (this.spriteRen != null) {
                    ...
                    colorRecursiveSprite(this.trans, toColor);
                } else {
			#endif
                    // Debug.Log("val:"+val+" tween:"+tween+" tween.diff:"+tween.diff);
                    if (this.type == TweenAction.COLOR) {
                        colorRecursive(this.trans, toColor, this.useRecursion);
                    }
        ...
        public LTDescr setMoveLocal() {
            ...
            this.easeInternal = () => {
                newVect = this.easeMethod();
                this.trans.localPosition = newVect;
            };
            return this;
        }
        ...
        public LTDescr setRotate() {
            ...
            this.initInternal = () => {
                ...
                this.to = new Vector3(
                    LeanTween.closestRot(this.fromInternal.x, this.toInternal.x),
                    LeanTween.closestRot(this.from.y, this.to.y),
                    LeanTween.closestRot(this.from.z, this.to.z)
                );
            };
            this.easeInternal = () => {
                newVect = this.easeMethod();
                this.trans.eulerAngles = newVect;
            };
            return this;
        }
        ...
        public LTDescr setRotateLocal() {
            ...
            this.easeInternal = () => {
                newVect = this.easeMethod();
                this.trans.localEulerAngles = newVect;
            };
            return this;
        }
        ...
        public LTDescr setGUIMove() {
            ...
            this.easeInternal = () => {
                Vector3 v = this.easeMethod();
                this._optional.ltRect.rect = new Rect(v.x, v.y, this._optional.ltRect.rect.width, this._optional.ltRect.rect.height);
            };
            return this;
        }
        ...
        public LTDescr setGUIScale() {
            ...
            this.easeInternal = () => {
                Vector3 v = this.easeMethod();
                this._optional.ltRect.rect = new Rect(this._optional.ltRect.rect.x, this._optional.ltRect.rect.y, v.x, v.y);
            };
            return this;
        }
        ...
        private void init() {
            ...
            this.usesNormalDt =
                !(this.useEstimatedTime
                  || this.useManualTime
                  || this.useFrames); // only set this to true if it uses non of the other timing modes
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
            if (this.delay <= 0f && directionLocal != 0f) {
                ...
                if (isTweenFinished) { // increment or flip tween
                    ...
                    if (isTweenFinished == false && this.onCompleteOnRepeat && this.hasExtraOnCompletes) {
                        this.callOnCompletes(); // this only gets called if onCompleteOnRepeat is set to true, otherwise LeanTween class takes care of calling it
                    }
     ...
     *         <li>
     *             <a href="http://www.robertpenner.com/easing/easing_demo.html">This page helps visualize the different easing equations</a>
     *         </li>
     *     </ul>
     *     @method setEase
     ...
     */
        ...
        private Vector3 tweenOnCurve() {
            return new Vector3(
                this.from.x + this.diff.x * this._optional.animationCurve.Evaluate(this.ratioPassed),
                this.from.y + this.diff.y * this._optional.animationCurve.Evaluate(this.ratioPassed),
                this.from.z + this.diff.z * this._optional.animationCurve.Evaluate(this.ratioPassed)
            );
        }
        ...
        private Vector3 easeInOutQuad() {
            ...
            if (val < 1f) {
                val = val * val;
                return new Vector3(
                    this.diffDiv2.x * val + this.from.x,
                    this.diffDiv2.y * val + this.from.y,
        ...
        private Vector3 easeInQuad() {
            val = this.ratioPassed * this.ratioPassed;
...
//		val = (val * val * val * val - 2f);
        ...
        private Vector3 easeInSine() {
            ...
            return new Vector3(
                this.diff.x * val + this.diff.x + this.from.x,
                this.diff.y * val + this.diff.y + this.from.y,
        ...
        private Vector3 easeInBounce() {
            ...
            val = 1f - val;
            return new Vector3(
                this.diff.x - LeanTween.easeOutBounce(0, this.diff.x, val) + this.from.x,
        ...
        private Vector3 easeInOutBounce() {
            ...
            if (val < 1f) {
                return new Vector3(
                    LeanTween.easeInBounce(0, this.diff.x, val) * 0.5f + this.from.x,
            ...
            val = val - 1f;
            return new Vector3(
                LeanTween.easeOutBounce(0, this.diff.x, val) * 0.5f + this.diffDiv2.x + this.from.x,
     ...
     *     <a href="http://docs.unity3d.com/Documentation/ScriptReference/AnimationCurve.html" target="_blank">AnimationCure</a> that describes the type of easing you
     *     want, this is great for when you want a unique type of movement
     *     @return {LTDescr} LTDescr an object that distinguishes the tween
     *     @example
     *     LeanTween.moveX(gameObject, 5f, 2.0f ).setEase( LeanTweenType.easeInBounce );
     */
     ...
     */
        ...
        public LTDescr setCanvasAlpha() {
            ...
            this.easeInternal = () => {
                ...
                if (this.useRecursion) {
                    alphaRecursive(this.rectTransform, val);
        ...
        public LTDescr setCanvasMoveX() {
            ...
            this.easeInternal = () => {
                ...
                this.rectTransform.anchoredPosition3D = new Vector3(this.easeMethod().x, c.y, c.z);
            };
            return this;
        }
        ...
        public LTDescr setCanvasMoveY() {
            ...
            this.easeInternal = () => {
                Vector3 c = this.rectTransform.anchoredPosition3D;
                this.rectTransform.anchoredPosition3D = new Vector3(c.x, this.easeMethod().x, c.z);
            };
            return this;
        }
        ...
        public LTDescr setCanvasMoveZ() {
            ...
            this.easeInternal = () => {
                Vector3 c = this.rectTransform.anchoredPosition3D;
                this.rectTransform.anchoredPosition3D = new Vector3(c.x, c.y, this.easeMethod().x);
            };
            return this;
        }
